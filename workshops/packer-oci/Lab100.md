...
This is the first of several labs which is part of **Oracle Public Cloud Build OCI images with Packer workshop**. This workshop will walk you through the process of creating customer OCI images in your own Oracle Cloud Trial account. 
